<?= $this->extend('owner/layout/default') ?>
<?= $this->section('title') ?>
            ...
            <div class="col-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form method="post" action="<?= base_url(); ?>/owner/formsregister/registeruser/process">
                            <?= csrf_field(); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    <label>Upline</label>
                                    <select class="form-control selectric" name="u_referensi" required>
