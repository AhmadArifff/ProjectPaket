...
<?= $this->section('title') ?>
<title>Forms Edit Register User &mdash; ARISYA</title>
<?= $this->endSection() ?>
...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="<?= base_url(); ?>/admin/formsregister/datauser">Data User</a></div>
            <div class="breadcrumb-item">Register User</div>
        </div>
    </div>
</section>
<section class="section">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="" id="text-editor">
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" class="form-control pwstrength" data-indicator="pwindicator" name="u_password" placeholder="Masukan Password" value="<?= $tb_user['u_password'] ?>" required>
                                    </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" class="form-control pwstrength" data-indicator="pwindicator" name="password-confirm" placeholder="Masukan Password Confirmation" value="<?= $tb_user['u_password'] ?>" required>
                                    </div>
                                    <div id="pwindicator" class="pwindicator">
                                        <div class="bar"></div>
                                        <div class="label"></div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="text" type="text" class="form-control" name="u_fullname" placeholder="Masukan Full Name" value="<?= $tb_user['u_fullname'] ?>" required>
                            </div>
                            <div class="row">
                                <div class="form-group col-6">
                                    <label>Role Akses</label>
                                    <select class="js-example-basic-single" name="u_role" required>
                                        <option value="<?= $tb_user['u_role'] ?>">--Pilih Role Akses--</option>
                                    ...
                                    <select class="js-example-basic-single" name="u_referensi" required>
                                        <?php foreach ($datauser as $data) { ?>
                                            <?php if ($tb_user['u_referensi'] == $data['u_id']) {
                                                ...
                                                <option value="<?= $tb_user['u_referensi'] ?>"><?= $selected == $data['u_nama'] ? $data['u_nama'] : '' ?></option>
                                            <?php }  ?>
                                        <?php } ?>
                                    </select>
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    <label>NIK KTP</label>
                                    <input type="text" class="form-control" placeholder="Masukan NIK KTP" name="u_nik" value="<?= $tb_user['u_nik'] ?>" required>
                                </div>
                                <div class="form-group col-6">
                                    <label>Nama Lengkap KTP</label>
                                    <input type="text" class="form-control" placeholder="Masukan Nama Lengkap KTP" name="u_nama" value="<?= $tb_user['u_nama'] ?>" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-6">
                                    <label>Tempat Lahir</label>
                                    <input type="text" class="form-control" placeholder="Masukan Tempat Lahir" name="u_tempat_lahir" value="<?= $tb_user['u_tempat_lahir'] ?>" required>
                                </div>
                                <div class="form-group col-6">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="Masukan Kelurahan" name="u_kelurahan" value="<?= $tb_user['u_kelurahan'] ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Kode Pos</label>
                                <input id="frist_name" type="text" class="form-control" name="u_kodepos" placeholder="Masukan Kode Pos" value="<?= $tb_user['u_kodepos'] ?>" required>
                            </div>
