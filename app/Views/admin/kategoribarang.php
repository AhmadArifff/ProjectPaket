            ...
            <div class="col-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <?= $this->include('admin/importexcelkategoribarang') ?>
                        <form method="post" action="<?= base_url(); ?>/admin/databarang/kategoribarang/process">
                            <?= csrf_field(); ?>
                            <div class="form-group">
                                <label for="">Nama Kategori Barang</label>
                                <input id="" type="text" class="form-control" name="k_nama" autofocus placeholder="Masukan Kategori Barang" required>
                            </div>
